  ...
  const absl::flat_hash_map<TestcaseKey, std::string>& GetDeviations()
    ...
    static const absl::flat_hash_map<TestcaseKey, std::string> deviations{
        ...
        {{"PdRcLoopbackMrTest", "BasicWriteMrOtherPdRemote"},
         "Provider does not support PD."},
        {{"PdRcLoopbackMrTest", "BasicAtomicFetchAddMrOtherPdLocal"},
         "Provider does not support PD."},
        {{"PdRcLoopbackMrTest", "BasicAtomicFetchAddMrOtherPdRemote"},
         "Provider does not support PD."},
        {{"PdRcLoopbackMrTest", "BasicAtomicCompSwapMrOtherPdLocal"},
         "Provider does not support PD."},
        {{"PdRcLoopbackMrTest", "BasicAtomicCompSwapMrOtherPdRemote"},
         "Provider does not support PD."},
